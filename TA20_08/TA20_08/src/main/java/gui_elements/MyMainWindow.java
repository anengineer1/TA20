...
public class MyMainWindow extends JFrame {
	...
	private void fillFrame() {
		...
		this.button_make_conversion = new JButton(this.TEXT_EUROS_A_PTAS + " (alt+z)");
		this.button_make_conversion.setBounds(10, 70, 180, 30);
		this.button_make_conversion.addActionListener(this.button_action_make_operation);
		this.button_make_conversion.setMnemonic('Z');
		this.content_pane.add(this.button_make_conversion);

		this.button_change_operation = new JButton("Cambiar (alt+x)");
		this.button_change_operation.setBounds(200, 70, 150, 30);
		this.button_change_operation.addActionListener(this.button_action_toggle);
		this.button_change_operation.setMnemonic('X');
		this.content_pane.add(this.button_change_operation);

		this.button_delete_contents = new JButton("Borrar (alt+c)");
		this.button_delete_contents.setBounds(360, 70, 140, 30);
		this.button_delete_contents.addActionListener(this.button_action_delete_content);
		this.button_delete_contents.setMnemonic('C');
		this.content_pane.add(this.button_delete_contents);
	...
	private void deleteContents() {
		this.textfield_money.setText("");
		this.textfield_money_converted.setText("");
	}
	...
	private void initActions() {
		this.button_action_make_operation = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					textfield_money_converted.setText("");
					JOptionPane.showMessageDialog(null, "Lo introducido no es un número real");
				}
			}
		};
		...
		this.button_action_delete_content = new ActionListener() {
